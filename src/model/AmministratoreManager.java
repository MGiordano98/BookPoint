...
public class AmministratoreManager {
	...
	public boolean aggiungiLibro(Libro libro) throws SQLException {
		...
		try{
			if(libro==null) throw new IllegalArgumentException("Isbn non corretto");
			...
			if(libro.getQuantit‡()==0) throw new IllegalArgumentException("Quantit‡ non corretta");
			if(libro.getCategoria()==null || libro.getCategoria().length()>30) throw new IllegalArgumentException("Categoria non corretta");
			if(libro.getDataUscita()==null) throw new IllegalArgumentException("Data Uscita non corretta");
	 ...
	 * @return true se il libro Ë stato eliminato con successo, altrimenti false
	 * @throws SQLException
	 */
	 ...
	 * @return true se la recensione Ë stata eliminata con successo, altrimenti false
	 * @throws SQLException
	 */
	 ...
	 * @return un Utente vuoto se non Ë stato ritrovato nessun account, altrimenti un Utente con i dati dell'account cercato
	 * @throws SQLException
	 */
	 ...
	 * @return true se il tipo Ë stato cambiato con successo, altrimenti false
	 * @throws SQLException
	 */
	 ...
	 * @return true se l'account Ë stato eliminato con successo, altrimenti false
	 * @throws SQLException
	 */
